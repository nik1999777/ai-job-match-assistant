...
Pre-eval fixes (DONE ✅):
  api/agents/nodes/parse.py      — LLM явно разбивает составные скиллы ("TypeScript + React" → 2 токена)
  api/agents/nodes/gap.py        — убраны захардкоженные слова-разделители, только пунктуация
