...
Результаты eval (2026-05-27, 12 кейсов, Llama 4 Scout):
  match_in_range: 11/12 (92%) ← лучший результат  |  MAE: 0.004 ← почти идеал
  skill_recall: 0.958  |  skill_precision: 0.737  |  F1: 0.772
...
Сравнение моделей:
  ...
  Groq llama-4-scout-17b   : 92%  MAE=0.004  F1=0.772  (3727ms, ~500K TPD) ← BEST
